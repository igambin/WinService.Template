...
using WinService.Logging.Appenders.MailRecipientManagement;
...
namespace WinService.Logging.Appenders
{
    public partial class MailNotificationAppender : AppenderSkeleton
    {
        ...
        {
            var env = Settings.SettingsReader.ApplicationSettings.EnvKey;
            var machineName = Settings.SettingsReader.ApplicationSettings.MachineName;
